...
<body>
        ...
        <nav class="navbar navbar-expand-md navbar-purple bg-purple navbar-laravel navbar-fixed-top">
            <div class="container-fluid">
                <a class="navbar-brand grow" style="font-weight:bolder;color:pink!important;" href="{{ url('/') }}">
                    {{ config('app.name') }}
                </a>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @else
                            <li class="nav-item dropdown">
                                <a style="color:blue!important;" id="navbarDropdown" class="nav-link dropdown-toggle grow b" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
